...
<%@ page import="cn.krain.crm.settings.entity.DicValue" %>
<%@ page import="java.util.Set" %>
<%@ page import="cn.krain.crm.workbench.entity.Transaction" %>
<%
...
<head>
  ...
  <script type="text/javascript">
      ...
      function showHistoryTranList() {
          $.ajax({
              url: "transaction/queryHistoryTranList.do",
              type: "post",
              data: {
      ...
      function changeStage(stage, i) {
          $.ajax({
              url: "transaction/changeTran.do",
              type: "post",
              data: {
                  "id": '${transaction.id}',
                  "stage": stage,
                  "money": '${transaction.money}',
                  "expetedDate": '${transaction.expectedDate}'
              },
              dataType: "json",
              success(data) {
                  if (data.success) {
                      $("#stage").html(data.transaction.stage);
                      $("#possibility").html(data.transaction.possibility);
                      $("#editBy").html(data.transaction.editBy);
                      $("#editTime").html(data.transaction.editTime);
...
<div style="position: relative; left: 40px; top: -50px;">
  阶段&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <%
    Transaction tran = (Transaction) request.getAttribute("transaction");
...
<div style="position: relative; top: 0px;">
  ...
  <div style="position: relative; left: 40px; height: 30px; top: 30px;">
    ...
    <div style="width: 300px;position: relative; left: 650px; top: -60px;"><b
            id="possibility">${transaction.possibility}</b></div>
    <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
    <div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
  </div>
  ...
  <div style="position: relative; left: 40px; height: 30px; top: 70px;">
    ...
    <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="editBy">${transaction.editBy}&nbsp;&nbsp;</b><small
            style="font-size: 10px; color: gray;" id="editTime">${transaction.editTime}</small></div>
    <div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
  </div>
...
<div style="position: relative; top: 100px; left: 40px;">
  ...
  <div class="remarkDiv" style="height: 60px;">
    ...
    <div style="position: relative; top: -40px; left: 40px;">
      <h5>哎呦！</h5>
      <font color="gray">交易</font> <font color="gray">-</font> <b>动力节点-交易01</b> <small style="color: gray;"> 2017-01-22
