...
<head>
  ...
  <script type="text/javascript">
      ...
      function showTranList() {
          $.ajax({
              url: "transaction/queryTransactionList.do",
              type: "post",
              dataType: "json",
              success(data) {
                  // alert("查询成功");
                  ...
                  $.each(data, function (i, n) {
                      ...
                      html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'transaction/detailTransaction.do?id=' + n.id + '\';">' + n.name + '</a></td>';
  ...
  <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
    ...
    <div class="btn-toolbar" role="toolbar"
      ...
      <div class="btn-group" style="position: relative; top: 18%;">
        <button type="button" class="btn btn-primary" onclick="window.location.href='workbench/transaction/save.jsp';">
